    ...
    Route::prefix('marketing')->name('marketing.')->group(function () {
        ...
        Route::prefix('imports/magazord')->name('magazord.')->group(function () {
            Route::get('/{type}', [MagazordImportController::class , 'show'])
                ->whereIn('type', ['estoque', 'custos', 'precos', 'inventario', 'descontos', 'produtos', 'vendas', 'vendas_itens', 'vendas_detalhes'])->name('show');
            Route::post('/{type}', [MagazordImportController::class , 'import'])
                ->whereIn('type', ['estoque', 'custos', 'precos', 'inventario', 'descontos', 'produtos', 'vendas', 'vendas_itens', 'vendas_detalhes'])->name('import');
        });
        ...
        Route::get('/inventory/planning/orders/{order}', [ReplenishmentController::class, 'order'])->name('inventory.planning.order');
